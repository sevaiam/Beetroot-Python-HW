...
from class_for_testing_new import ProductStore, Product
...
class TestProductStore(TestCase):
    ...
    def test_get_income(self):
        ...
        self.store.add(self.prod1, 10)
        self.store.sell_product('Football T-Shirt', 4)
        self.assertEqual(self.store.get_income(), 520.0)

    def test_get_all_products(self):
        self.store.add(self.prod, 5)
        self.store.add(self.prod1, 10)
        self.store.sell_product('Football T-Shirt', 4)
        self.assertEqual(self.store.products, self.store.get_all_products())
